...
type StreamDirector func(incomingCtx context.Context, fullMethodName string, processor RequestProcessor) error

type RequestProcessor func(outgoingCtx context.Context, conn *grpc.ClientConn) error
